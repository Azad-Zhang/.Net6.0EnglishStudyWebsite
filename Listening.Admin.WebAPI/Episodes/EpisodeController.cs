...
public class EpisodeController : ControllerBase
{
    ...
    public async Task<ActionResult<Guid>> Add(EpisodeAddRequest req)
    {
        ...
        else
        {
            ...
            EncodingEpisodeInfo encodingEpisode = new EncodingEpisodeInfo(episodeId, req.Name, req.AlbumId, req.DurationInSecond, req.Subtitle, req.SubtitleType, "Created");//这里并没有给文件url啊？
