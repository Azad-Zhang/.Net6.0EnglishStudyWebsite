...
namespace FileService.SDK.NETCore
{
    public class FileServiceClient
    {
        ...
        //    }
        //}
        //public async Task<Uri> UploadAsync(IFormFile file, CancellationToken stoppingToken = default)
        //{
        //    string token = BuildToken();
        //    using MultipartFormDataContent content = new MultipartFormDataContent();
        ...
        //    //var respMsg = await httpClient.PostAsync(requestUri, new StreamContent(fileStream), stoppingToken);
        ...
        public async Task<Uri> UploadAsync(FileUploadDto file, CancellationToken stoppingToken = default)
        {
            ...
            {
                string respString = await respMsg.Content.ReadAsStringAsync(stoppingToken);
                var mySrc = respString.ParseJson<Uri>()!;
